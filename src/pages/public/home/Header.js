    ...
    <div className="bg-header_bg bg-center bg-no-repeat bg-cover px-6 py-32 relative w-full md:px-12 lg:px-20">
      ...
      <div className="z-10 relative flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-7 items-center sm:flex-row sm:gap-14">
          ...
          <button className="flex w-full justify-center max-w-[200px] rounded-sm border-2 border-[#EF4D48]  fill-white px-12 py-5 text-lg font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 hover:cursor-pointer">
            Contact Us
          </button>
        </div>
      </div>
