...
function EditBioData({ biodata }) {
  ...
  const [caste, setCaste] = useState(
    biodata.caste.charAt(0).toUpperCase() + biodata.caste.slice(1) || ""
  );

  const [subcaste, setSubcaste] = useState(
    biodata.subcaste.charAt(0).toUpperCase() + biodata.subcaste.slice(1) || ""
  );
  const [gotra, setGotra] = useState(
    biodata.gotra.charAt(0).toUpperCase() + biodata.gotra.slice(1) || ""
  );
  ...
  const [currentAddressLocation, setCurrentAddressLocation] = useState(
    biodata.currentAddressLocation || ""
  );
    ...
    <div className="w-full flex justify-center my-4">
      <Formik
        initialValues={{
          ...
          surname:
            biodata.surname.charAt(0).toUpperCase() + biodata.surname.slice(1),
          caste: biodata.caste,
          ...
          notWorkingOrStudyingDetails: biodata.notWorkingOrStudyingDetails,
