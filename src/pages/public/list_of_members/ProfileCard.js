...
const ProfileCard = ({ data, showCard, setShowCard }) => {
  ...
  return (
    <div className="fixed flex flex-col justify-center items-center w-screen h-screen top-0 left-0 bg-[#323233] bg-opacity-90 overflow-x-auto py-5">
      <div
        className="w-full flex justify-end pr-20 hover:cursor-pointer group mt-5"
        onClick={() => {
          setShowCard(null);
        }}
      >
      ...
      <div className="w-full  border-4 rounded-b-xl border-[#EF4D48] font-Poppins max-w-md  min-w-[350px] box-border  bg-gradient-to-r from-[#FFDD57] to-[#FE954C]">
        <div className="flex justify-center items-center w-full rounded-b-2xl bg-[#EF4D48] p-3">
          <h1 className="text-[#fff] font-semibold text-2xl font-Poppins w-full text-center whitespace-nowrap">
            {/* Trustee Member */}
            {/* TRUSTEE MEMBERS */}
        ...
        <div className="w-full p-5 flex justify-center items-center flex-col gap-4">
          ...
          <div className="w-full flex flex-col gap-1 justify-center items-center">
            <p className="text-[28px] font-bold text-[#EF4D48]  whitespace-nowrap">
              {name}
            </p>
            <h3 className="text-xl font-medium text-[#444]  whitespace-nowrap">
              {profession}
            </h3>
          </div>
