...
import { POST_PRESS_CUTOUT } from "../../../utils/constants";
import axios from "axios";
import AdminContext from "../../../utils/context/Admincontext";

const FormAddNewPressCutout = () => {
  ...
  return (
    <Formik
      ...
      onSubmit={async (values, { setSubmitting, resetForm }) => {
        ...
        try {
          const response = await axios.post(POST_PRESS_CUTOUT, reqBody, {
            headers: {
...
export default FormAddNewPressCutout;
