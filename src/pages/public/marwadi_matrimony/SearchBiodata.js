      ...
      {searchedBiodatas === null ? (
        ...
        <div className="w-full max-w-6xl flex justify-center p-5 flex-col">
          ...
          <div className="w-full flex justify-center items-center">
            {searchedBiodatas && searchedBiodatas?.length === 0 ? (
              <div className="w-full flex flex-col justify-center items-center gap-8">
                ...
                <div>
                  <button
                    onClick={() => {
                      setSearchedBiodatas(null);
                      setStep(1);
                    }}
                    className="flex gap-2 w-full justify-center  font-Poppins rounded-md bg-[#EF4D48] px-5 py-4 text-lg font-semibold leading-6 text-white shadow-sm "
                  >
                    Try Again
                  </button>
                </div>
